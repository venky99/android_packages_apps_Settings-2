...
public class NotificationsShortcutFragment extends SettingsPreferenceFragment {
    ...
    private static final String NOTIFICATION_SHORTCUTS_COLOR_MODE = "pref_notification_shortcuts_color_mode";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNotificationShortcutsColor = (ColorPickerPreference) findPreference(NOTIFICATION_SHORTCUTS_COLOR);
        ...
        mNotificationShortcutsColorMode.setValue(String.valueOf(
                ...
                Settings.System.NOTIFICATION_SHORTCUTS_COLOR_MODE, 1,
                UserHandle.USER_CURRENT_OR_SELF)));
        mNotificationShortcutsColorMode.setSummary(mNotificationShortcutsColorMode.getEntry());

        mNotificationShortcutsColorMode.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
            public boolean onPreferenceChange(Preference preference,
                        Object newValue) {
                ...
                mNotificationShortcutsColorMode.setSummary(mNotificationShortcutsColorMode.getEntries()[index]);
                return true;
            }
        });
